...
export class JqxgridFrService {

  constructor() {
  }

  public getLocalization(culture: string): any {
        ...
        localization =
          {
            ...
            sortremovestring: 'Suprrimer le tri',
            clearstring: 'Restaurer',
            todaystring: 'aujourd\'hui',
            thousandsSeparator: ' ',
            filterstringcomparisonoperators: ['vide', 'non vide', 'contient', 'contient(match case)',
              'ne contient pas', 'ne contient pas(match case)', 'commence avec', 'commence avec(match case)',
              'se termine par', 'se termine par(match case)', 'égale', 'égale(match case)', 'null', 'non null'],
            filternumericcomparisonoperators: ['égale', 'différent', 'inférieur à', 'inférieur ou égal', 'supérieur à', 'supérieur ou égal', 'null', 'non null'],
            filterdatecomparisonoperators: ['égale', 'différent', 'inférieur à', 'inférieur ou égal', 'supérieur à', 'supérieur ou égal', 'null', 'non null'],
            filterbooleancomparisonoperators: ['égale', 'différent'],
            loadtext: 'Chargement...',
          };
        break;
      case 'en':
  ...
  public configCellWidthInSmallDevice(columns, newWidht) {
    if (window.innerWidth < 768) {
      for (let column of columns) {
        let addedWidt = newWidht != null ? newWidht : 30;
        column.width = Number(column.width.replace('%', '')) + addedWidt + '%';
      }
    }
  }
}
